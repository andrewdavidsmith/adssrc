...
public:
  ...
  std::string get_bitlabel() const {return bitlabel;}
...
private:
  ...
  std::string name;
  std::string bitlabel; // ADS: this bitlabel needs to be removed
...
private:
  ...
  void set_bitlabel(std::vector<std::string> &bitlabels);
  void set_leaf_num();
